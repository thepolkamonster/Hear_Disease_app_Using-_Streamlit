...
if uploaded_file is not None:
    ...
    def user_features():
        ...
        fbs = st.sidebar.slider("Fasting Blood Sugar", 0, 1, 0.34)
        ...
        oldpeak = st.sidebar.slider("Oldpeak, ST depression induced by exercise relative to rest", 6.2, 0, 1.07)
...
load_clf = pickle.load(open('hear-clf.pkl','rb'))
